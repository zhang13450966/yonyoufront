 ...
 * @Last Modified time: 2021-06-17 15:30:24
 */
...
export default function commit() {
	...
	ajax({
		...
		success: (res) => {
			...
			if (res.success) {
				showSuccessInfo(getLangByResId(this, '4004ORDERREVISE-000030')); /* 国际化处理： 收回成功！*/
			} else {
				showErrorInfo(null, getLangByResId(this, '4004ORDERREVISE-000031')); /* 国际化处理：收回失败！*/
			}
		}
	});
}
