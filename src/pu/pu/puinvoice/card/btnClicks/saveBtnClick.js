 ...
 * @Author: jiangfw 
 * @PageInfo: 保存按钮
 * @Date: 2018-04-25 20:57:51 
 * @Last Modified by: zhangmi
 * @Last Modified time: 2022-04-02 16:37:49
 */
...
export default function clickSaveBtn(skipCodes, callback) {
				...
				if (res.success && res.data) {
					...
					if (res.data.isResume && res.data.isResume == true) {
						showResumeModal.call(
							...
							skipCodes,
							res.data,
							clickSaveBtn.bind(this, skipCodes, callback),
							props
						);
						return;
					}
					...
					showSuccessInfo(getLangByResId(this, '4004PUINVOICE-000021' /* 国际化处理： 保存成功*/));
