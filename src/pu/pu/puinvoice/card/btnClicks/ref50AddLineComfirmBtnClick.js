 ...
 * @Last Modified time: 2020-09-25 15:54:11
 */
import { ajax } from 'nc-lightapp-front';
import { PAGECODE, FIELD, MODAL_ID, URL, AREA, ADD_ROW_FIELDS } from '../../constance';
...
export default function ref50AddLineComfirmBtnClick(ids) {
	...
	if (ids) {
		...
		let info50 = {
			...
			oid: this.qTempletid_50,
			// key: 'ic_vmi_outdetail.cvmibid'
			key: 'ic_vmi_sum.cvmihid'
		};
		transferInfo.push(info50);

		ajax({
			url: URL.transfer50to25,
			data: info50,
			success: (res) => {
