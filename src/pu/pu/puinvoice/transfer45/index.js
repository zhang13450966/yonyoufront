 ...
 * @Last Modified time: 2021-10-09 15:50:14
 */
			...
			<div id="transferList" className="nc-bill-list">
							...
							{appid ? (
								<div className="header-title-search-area">
									...
									<h2 className="title-search-detail">
										{getLangByResId(this, '4004PUINVOICE-000034')}
									</h2>
									{/* 国际化处理：采购入库单*/}
								</div>
							) : (
								<div className="header-title-search-area">
									{createCardTitle(this, {
										title: getLangByResId(this, '4004PUINVOICE-000034') /* 国际化处理：采购入库单*/,
										backBtnClick: () => {
				...
				<div className="nc-bill-transferTable-area">
					{createTransferTable({
						...
						searchAreaCode: AREA.search45, // 用于缓存查询条件
