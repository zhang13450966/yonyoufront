 ...
 * @Last Modified time: 2021-10-13 09:48:04
 */
...
class Transfer61Table extends Component {
	constructor(props) {
		super(props);
			...
			<div id="transferList" className="nc-bill-list">
							...
							{appid ? (
								<div className="header-title-search-area">
									...
									<h2 className="title-search-detail">
										{getLangByResId(this, '4004PUINVOICE-000036')}
									</h2>
									{/* 国际化处理：委外订单*/}
								</div>
							) : (
								<div className="header-title-search-area">
									{createCardTitle(this, {
										title: getLangByResId(this, '4004PUINVOICE-000036') /* 国际化处理：委外订单*/,
										backBtnClick: () => {
				...
				<div className="nc-bill-transferTable-area">
					{createTransferTable({
						...
						searchAreaCode: AREA.search61, // 用于缓存查询条件
...
Transfer61Table = createPage({})(Transfer61Table);
export default Transfer61Table;
