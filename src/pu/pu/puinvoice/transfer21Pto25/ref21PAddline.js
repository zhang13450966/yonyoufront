 ...
 * @Last Modified time: 2022-05-26 13:53:56
 */
...
class Ref21PAddline extends Component {
	constructor(props) {
		super(props);
					...
					<div>
						<NCDiv areaCode={NCDiv.config.HEADER} className="nc-bill-header-area">
							<div className="header-title-search-area">
								<h2 className="title-search-detail">{getLangByResId(this, '4004PUINVOICE-000093')}</h2>
								{/* 国际化处理：采购订单付款计划*/}
							</div>
						...
						onTransferBtnClick: (ids) => {
							...
							if (this.isRefAddLine == true) {
								...
								this.props.pushTo(URL.card, {
									...
									status: UISTATE.edit,
									qTempletid_50: this.state.qTempletid_21P,
									appid: this.state.appid,
...
Ref21PAddline = createPage({})(Ref21PAddline);
export default Ref21PAddline;
