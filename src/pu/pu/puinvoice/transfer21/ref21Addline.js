 ...
 * @Last Modified time: 2021-09-11 22:37:42
 */
...
class Ref21Addline extends Component {
	constructor(props) {
		super(props);
					...
					<div>
						<NCDiv areaCode={NCDiv.config.HEADER} className="nc-bill-header-area">
							<div className="header-title-search-area">
								<h2 className="title-search-detail">{getLangByResId(this, '4004PUINVOICE-000033')}</h2>
								{/* 国际化处理：采购订单*/}
							</div>
...
Ref21Addline = createPage({})(Ref21Addline);
export default Ref21Addline;
