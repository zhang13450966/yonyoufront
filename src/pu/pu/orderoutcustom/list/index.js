/*
 * @Author: liujia9 
 * @PageInfo: 采购订单状态维护-出关 
 * @Date: 2019-04-10 17:01:10 
 * @Last Modified by: zhr
 * @Last Modified time: 2021-09-10 20:43:38
 */
...
const { NCDiv } = base;
class OutCustomList extends Component {
	constructor(props) {
		super(props);
		props.use.search(AREA.searchId);
		props.use.table(AREA.listTableId);
		this.state = {};
		this.isOutCustom = false;
		initLang(this, [ '4004orderoutcustom' ], 'pu', initTemplate.bind(this, this.props));
	}
