 ...
 * @Last Modified time: 2021-08-05 14:39:06
 */
...
function setButtonState() {
	...
	this.props.button.setButtonVisible([ BUTTONID.OutCustom ], !custom);
	this.props.button.setButtonVisible([ BUTTONID.UnOutCustom ], custom);
...
function onRowsSelected(props) {
	...
	if (checkedRows && checkedRows.length > 0) {
		this.props.button.setDisabled({
			[BUTTONID.OutCustom]: false,
			[BUTTONID.UnOutCustom]: false
		});
	} else {
		this.props.button.setDisabled({
			[BUTTONID.OutCustom]: true,
			[BUTTONID.UnOutCustom]: true
		});
	}
}
...
function setEmptyValueDisplay(props) {
	...
	props.button.setButtonVisible(
		[ BUTTONID.Print, BUTTONID.Refresh, BUTTONID.OutCustom, BUTTONID.UnOutCustom ],
		false
	);
