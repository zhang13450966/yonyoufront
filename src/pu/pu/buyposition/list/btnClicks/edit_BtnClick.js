/*
 * @Author: yechd5 
 * @PageInfo: 采购员物料设置修改处理
 * @Date: 2018-05-10 09:39:02 
 * @Last Modified by: yechd5
 * @Last Modified time: 2018-08-31 12:28:59
 */
...
export default function clickEditBtn(props) {
	...
	// 设置“岗位编码” 不可以修改
	let allDatas = props.editTable.getAllRows(BUYPOSITION_CONST.TABLEID);
	if (allDatas) {
		for (let i = 0; i < allDatas.length; i++) {
			let rowid = allDatas[i].rowid;
			props.editTable.setEditableByKey(BUYPOSITION_CONST.TABLEID, rowid, 'code', false);
		}
	}
