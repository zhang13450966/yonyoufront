/*
 * @Author: zhaochyu
 * @PageInfo: 采购订单付款计划执行查询
 * @Date: 2018-06-27 11:17:51
 * @Last Modified by: zhr
 * @Last Modified time: 2021-10-30 15:02:43
 */
import React, { Component } from 'react';
import ReactDOM from 'react-dom';
import { SimpleReport } from 'nc-report';
import { FIELD } from './constance';
import { disposeFilter, systemFormulaRenderCompleteProcess, getFieldValue2Arr } from '../public/utils';
import multiCorpRefHandler from '../../../../scmpub/scmpub/pub/tool/MultiCorpRefHandler';
import { setPsndocShowLeavePower, setRefShowDisabledData } from '../../../../scmpub/scmpub/pub/tool';
import getUrlParam from '../../../../scmpub/scmpub/pub/tool/getUrlParam';

export default class OrderPrayExecQuery extends Component {
	constructor(props) {
		super(props);
	}
	/**
    ...
    */
	renderCompleteEvent(props, searchId) {
		...
		if (params) {
			...
			props.search.setSearchValByField(searchId, FIELD.pk_org, params[FIELD.pk_org]);
			props.search.setSearchValByField(searchId, FIELD.dbilldate, {
				value: [ params[FIELD.dbilldate], params[FIELD.dbilldate] ],
				display: ''
			});
			props.search.setSearchValByField(searchId, FIELD.vbillcode, params[FIELD.vbillcode]);
		}
...
ReactDOM.render(<OrderPrayExecQuery />, document.getElementById('app'));
