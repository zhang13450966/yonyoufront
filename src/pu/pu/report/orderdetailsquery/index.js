 ...
 * @Author: zhaochyu
 * @PageInfo: 采购订单明细查询
 * @Date: 2018-06-26 19:18:03
 * @Last Modified by: raoczh
 * @Last Modified time: 2020-12-28 15:17:04
 */
...
export default class OrderDetailQuery extends Component {
	constructor(props) {
		super(props);
	}
	/**
   ...
   */
	disposeSearch(meta, props) {
		...
		items.map((item) => {
			...
			if (code == FIELD.pk_supplierAreac || code == FIELD.pk_marbasclassCode || code == FIELD.cprojectid) {
...
ReactDOM.render(<OrderDetailQuery />, document.getElementById('app'));
