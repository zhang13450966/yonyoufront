...
export default function (props = {}) {
    var conf = { multiLang: {  domainName: 'hrpub', currentLocale: 'zh-CN',  moduleId: 'hrpub'},
        refType: 'grid',
        refName: 'hrpub-000009',/* 国际化处理： 能力素质指标*/
        placeholder: 'hrpub-000009',/* 国际化处理： 能力素质指标*/
        refCode: 'hrpub.refer.pub.CindexGridRef',
        queryGridUrl: '/nccloud/hrpub/ref/CindexGridRef.do',
