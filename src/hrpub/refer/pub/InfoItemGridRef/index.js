...
export default function (props = {}) {
    var conf = { multiLang: {  domainName: 'hrpub', currentLocale: 'zh-CN',  moduleId: 'hrpub'},
        refType: 'grid',
        refName: 'hrpub-000104',/* 国际化处理： 能力素质指标*/
        placeholder: 'hrpub-000104',/* 国际化处理： 能力素质指标*/
        refCode: 'hrpub.refer.pub.InfoItemGridRef',
        queryGridUrl: '/nccloud/hrpub/ref/InfoItemGridRef.do',
