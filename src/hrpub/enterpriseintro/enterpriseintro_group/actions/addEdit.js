...
export default class AddEditAction {
    ...
    saveFun = async () => {
        ...
        const {dispatch, enterpriseGroup} = props
        const {json, profile, imgBase64, proname, pk_orgprofile, enablestate, pk_group} = enterpriseGroup
        ...
        let res = await dispatch({
            type: 'enterpriseGroup/orgProFileSaveAction',
            payload: {
                postData: {
                    model: {
                        areaType: 'form',
    ...
    setPronameAndProfile = async (record) => {
        ...
        let res = await dispatch({
            type: 'enterpriseGroup/orgProFileQueryOneAction',
            payload: {
                postData: {
                    pk_orgprofile
                }
