...
const AddEditModel = render({
    ...
    return(
        <div className="addEditModel">
            <NCModal visible={enterpriseGroup.showModel}
                  mask={false}
                  onCancel={props.closeModel}>
                <NCModal.Header>
                  <NCModal.Title>{enterpriseGroup.modelTitle}</NCModal.Title>
                </NCModal.Header>
                <NCModal.Body>
                        ...
                        <div className="modalLeft">
                            ...
                            <div className="mlDom mlTopMar">
                                ...
                                <input 
                                    ...
                                    value={enterpriseGroup.profile}
                                    onChange={props.profileChange}/>
                            </div>
                        </div>
                        <div className="modalRight">
                            <div className="mrDom">
                                <div className="positionImg hrfont hr-tupianzhanwei-" style={{display: enterpriseGroup.imgBase64 ? 'none' : 'block'}}></div>
                                <img className="uploadImg" src={enterpriseGroup.imgBase64} alt=""/>
