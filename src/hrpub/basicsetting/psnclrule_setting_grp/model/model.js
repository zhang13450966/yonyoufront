...
class Model extends CommonModel{
    ...
    data ={
        ...
        showTransferModal: false,    // 分配穿梭弹窗是否显示
        selectedIndex: 0,
        isneedfile: false,
    ...
    async = {
        ...
        getTableData(dispatch,getstate,data){
            return proFetch({
                url: '/nccloud/hrpub/psnclrule/PsnclruleInitGrpAction.do',
                body: data
            })
        },
        ...
        // 分配初始化数据
        assignInitData(dispatch, getstate, data){
            return proFetch({
                url: '/nccloud/hrpub/psnclrule/PsnclruleAssignGrpRuleInitAction.do',
                body: data
            })
        },

        // 分配确定确定校验
        assignCheckAction(dispatch, getstate, data){
            return proFetch({
                url: '/nccloud/hrpub/psnclrule/PsnclruleAssignCheckAction.do',
                body: data
            })
        },

        //分配
        assignAction(dispatch, getstate, data){
            return proFetch({
                url: '/nccloud/hrpub/psnclrule/PsnclruleAssignDoAction.do',
                body: data
            })
        }
    }
