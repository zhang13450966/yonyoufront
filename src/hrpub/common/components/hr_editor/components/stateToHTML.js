...
var _draftJsUtils = require('./draft-js-utils/lib/main');
...
var DEFAULT_STYLE_MAP = ((_DEFAULT_STYLE_MAP = {}),
...
var ENTITY_ATTR_MAP = ((_ENTITY_ATTR_MAP = {}),
...
var DATA_TO_ATTR = ((_DATA_TO_ATTR = {}),
_defineProperty(_DATA_TO_ATTR, _draftJsUtils.ENTITY_TYPE.LINK, function(entityType, entity) {
...
var MarkupGenerator =
	...
	(function() {
		...
		function MarkupGenerator(contentState, options) {
			...
			var _combineOrderedStyles = (0, _combineOrderedStyles3['default'])(options.inlineStyles, [
					DEFAULT_STYLE_MAP,
					DEFAULT_STYLE_ORDER
				]),
		...
		_createClass(MarkupGenerator, [
			...
			},
			{
				...
				value: function writeStartTag(block, defaultBlockTag) {
					...
					try {
						for (
							var _iterator = tags[Symbol.iterator](), _step;
							!(_iteratorNormalCompletion = (_step = _iterator.next()).done);
							_iteratorNormalCompletion = true
						) {
							var tag = _step.value;
							// attrString = !attributes
							// 	? stringifyAttrs(tagStyleMap(tag))
							// 	: _objectSpread({}, attributes, tagStyleMap(tag));
			...
			},
			{
				...
				value: function writeEndTag(block, defaultBlockTag) {
					...
					if (tags.length === 1) {
						...
						try {
							for (
								var _iterator2 = tags[Symbol.iterator](), _step2;
						...
						.map(function(_ref2) {
							...
							var content = stylePieces
								.map(function(_ref4) {
									...
									try {
										for (
											var _iterator3 = _this.styleOrder[Symbol.iterator](), _step3;
							...
							if (
								entity != null &&
								_this.options.entityStyleFn &&
								(entityStyle = _this.options.entityStyleFn(entity))
							) {
								...
								var attrs = DATA_TO_ATTR.hasOwnProperty(entityType)
								...
								var _attrs = DATA_TO_ATTR.hasOwnProperty(entityType)
									? DATA_TO_ATTR[entityType](entityType, entity)
									: null;
