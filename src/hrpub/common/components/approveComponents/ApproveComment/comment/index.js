...
export default class Comment extends React.Component{
    ...
    render(){
        let { commonList, iniInput, enableInput, minWidth, minHeight, noShadow, setComment, update, isDetail, autoFocus, id } = this.props;
        return (
            <div className="areaWrapper nc-theme-from-input-bgc nc-theme-from-input-bc" style={{width: minWidth}}>
