...
import { getMultiLang, ajax, toast, base } from 'nc-lightapp-front';
...
export default class ApproveBtns extends Component {
    ...
    detailDoApprove = () =>  {
        ...
        this.setState({addApproveSuggestion: ''}); // 确认后清空意见
    }
    //点击批准按钮判断逻辑
    onPass = () => {
        ...
        ajax({
            ...
            success: (res) => {
                ...
                if(data && data.content){
                    ...
                    toast({color: 'error', content: this.state.json['approvebtns_002']}); // approvebtns_002 操作失败
                }else{
    ...
    render() {
        ...
        return <span className="approve-btns">
            ...
            <NCModal
                ...
                <Body>
                    ...
                    {this.state.resumeDetail && this.state.resumeDetail.url ?
                        <iframe src={this.state.resumeDetail.url} style={{ minWidth: "1250px", maxWidth: "1860px" }} id="resumeDetailIframe" scrolling="yes"
                            onLoad={
                                () => {
            ...
            {/* 撤销确认弹框 */}
            <NCModal fieldid="unApprove-confirm" visible={this.state.unApproveConfirmModal}>
            ...
            {/* 加签弹框 */}
            <NCModal fieldid="addApprover" className="form-modal" mask={true} show={this.state.showAddApproveModal}>
                    <NCModal.Header>
                    ...
                    <NCModal.Body>
                        <div className="body-content">
                            ...
                            <div className="content-inner">
                                <div className="label">{json['approvebtns_026']}</div>{/* 国际化处理： 输入批语*/}
                                <div className="content">
                                    <NCTextArea fieldid="comment" value={this.state.addApproveSuggestion} onChange={this.addApproveSuggestChange} showMax={true} maxlength={500}/>
                                    {/* <NCFormControl
                                        fieldid="comment"
