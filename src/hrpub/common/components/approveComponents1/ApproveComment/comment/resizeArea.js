...
export default class ResizableTextArea extends React.Component{
    ...
    componentDidMount(){
        if(this.dragHot){
            this.dragHot.addEventListener('mousedown', this.onEnableDrag);
    ...
    componentWillUnmount(){
        this.dragHot.removeEventListener('mousedown', this.onEnableDrag);
    ...
    removeEventListener(){
        ...
        document.removeEventListener('mouseup', this.onDisableDrag);
    ...
    onEnableDrag(e){
        ...
        document.addEventListener('mouseup', this.onDisableDrag);
    ...
    hideCommonList(e){
        ...
        // if(this.state.inputMode && this.state.showCommonList){
