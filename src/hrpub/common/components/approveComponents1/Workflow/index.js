        ...
        return <div>
            <div className="approve-comment nc-theme-sp-detail-bgc">
                <div className="comment-sel">
                    {/* 上传附件 */}
                    <span fieldid={getSysFieldid('fujian')} className="sel-item nc-theme-sp-common-font-c" onClick={(eve) => { this.setState({ showUploader: !showUploader }) }}>{json['index_013']}</span>
                </div>
                {/* 上传附件 */}
