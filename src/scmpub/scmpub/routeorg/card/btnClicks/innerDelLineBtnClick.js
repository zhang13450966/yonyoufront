 ...
 * @Last Modified time: 2021-03-15 11:25:58
 */
...
export default function innerDelLineClick(props, index) {
	if ((index instanceof Array && index[0] != 0) || (!(index instanceof Array) && index != 0)) {
		...
		const title = getLangByResId(this, '4001ROUTE-000026'); /**删除表体行提示 */
		const content = getLangByResId(this, '4001ROUTE-000027'); /**确认删除起始站点？ */
