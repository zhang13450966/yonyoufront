 ...
 * @Last Modified time: 2020-12-29 15:12:12
 */
...
function beSureBtnClick(props) {
	...
	ajax({
		...
		success: (res) => {
			...
			props.button.setButtonsVisible(CARDBUTTONINFO.StopUse, false);
			props.button.setButtonsVisible(CARDBUTTONINFO.StartUse, true);
			props.button.setDisabled(CARDBUTTONINFO.StopUse, true);
			props.button.setDisabled(CARDBUTTONINFO.StartUse, false);
