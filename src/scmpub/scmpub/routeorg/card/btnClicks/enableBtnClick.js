 ...
 * @Last Modified time: 2020-12-29 15:11:54
 */
import { ajax } from 'nc-lightapp-front';
import { CARDBUTTONINFO, CARDTEMPLATEINFO, ROUTEVOINFO, REQUESTURL } from '../../const/index';
...
function beSureBtnClick(props) {
	...
	ajax({
		...
		success: (res) => {
			...
			props.button.setButtonsVisible(CARDBUTTONINFO.StopUse, true);
			props.button.setButtonsVisible(CARDBUTTONINFO.StartUse, false);
			props.button.setDisabled(CARDBUTTONINFO.StopUse, false);
			props.button.setDisabled(CARDBUTTONINFO.StartUse, true);
		}
	});
}
