 ...
 * @Last Modified time: 2020-12-31 13:52:47
 */
...
import OrgChangeBtnClick from './orgChangeBtnClick';
...
export default function onButtonClicks(props, btnCode, record, index) {
	switch (btnCode) {
		...
		case BUTTONINFO.showOffBtnCode:
			...
			break;
		case BUTTONINFO.OrgChangeBtnCode:
			OrgChangeBtnClick.call(this, props, record);
			break;
