 ...
 * @Last Modified time: 2020-12-30 16:40:22
 */
import { ajax, toast } from 'nc-lightapp-front';
import { AREA, URL } from '../../constance';
import { showWarningDialog, showBatchOprMessage } from '../../../pub/tool/messageUtil';
	...
	ajax({
		...
		success: (res) => {
			if (res.success) {
				...
				showBatchOprMessage(
					getLangByResId(this, '4001CARRIERGROUP-000018'),
					res.data
				); /* 国际化处理： 删除成功*/ /* 国际化处理： 删除成功！*/
				//调用缓冲方法
				...
				toast({
					color: 'warning',
					content: getLangByResId(this, '4001CARRIERGROUP-000019') /* 国际化处理： 删除失败*/
				});
			}
		}
	});
