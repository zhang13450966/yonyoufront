 ...
 * @Last Modified time: 2021-08-03 10:41:57
 */
...
export default function saveBtnClick(props) {
	...
	let data = this.props.createMasterChildDataSimple(PAGEID.cardpagecodegroupc, AREA.card_head, AREA.driver);
		...
		ajax({
			...
			success: (res) => {
				...
				if (res.data && res.data.card_head) {
					...
					showSuccessInfo(getLangByResId(this, '4001CARRIERGROUP-000006')); /* 国际化处理： 保存成功!*/
