 ...
 * @Last Modified by: 刘奇
 * @Last Modified time: 2019-03-06 16:06:25
 */

import { BILL_STATUS, BUTTON_AREA, LIST_INNER_BUTTONS, PrepaidinvoiceHeadItem } from '../../const';
...
export default function(props, text, record, index) {
	let billstatus = record == undefined ? '' : record[PrepaidinvoiceHeadItem.fstatusflag].value;
