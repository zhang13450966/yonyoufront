 ...
 * @Last Modified time: 2021-09-06 10:40:29
 */
...
export default function billCloseBtnClick(props, skipCodes) {
	// 获取卡片页表头表体pk-ts关系
	...
	ajax({
		url: ARSUB_CONST.cardbillcloseUrl,
		data: data,
		success: (res) => {
			if (res.success && res.data) {
				...
				if (res.data.isResume && res.data.isResume == true) {
					...
					showResumeModal.bind(this)(
						...
						skipCodes,
						res.data,
						billCloseBtnClick.bind(this, props, skipCodes)
					);
					return;
				} else {
					batchOperateUtils.singleOp.call(this, props, res, {
						messageTitle: getLangByResId(this, '4006ARSUB-000014')
					}); /* 国际化处理： 关闭成功*/
				}
			}
		}
