...
import { ARSUB_CONST, CARD_BODY_BUTTONS } from '../../const';
...
export default function buttonClick(props, record, index) {
	rowCopyPasteUtils.cancel.call(this, props, ARSUB_CONST.tableId, CARD_BODY_BUTTONS.EDIT, CARD_BODY_BUTTONS.PASTE);
