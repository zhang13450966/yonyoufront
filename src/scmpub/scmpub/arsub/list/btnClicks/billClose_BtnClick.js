 ...
 * @Last Modified time: 2020-03-20 18:12:32
 */
...
export default function billClose_BtnClick(props) {
	...
	ajax({
		url: ARSUB_CONST.listbillcloseUrl,
		...
		success: (res) => {
			...
			if (success) {
				showBatchOprMessage(
					...
					res.data,
					{},
					getLangByResId(this, '4006ARSUB-000023')
				); /* 国际化处理： 提示,整单关闭成功！*/
