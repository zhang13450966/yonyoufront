...
function setButtonState() {
	let queryInfo = getDefData(REF4621_CONST.dataSource, REF4621_CONST.searchId);
	if (queryInfo == null) {
		this.props.button.setButtonDisabled([ REF4621_CONST.refresh ], true);
	} else {
		this.props.button.setButtonDisabled([ REF4621_CONST.refresh ], false);
	}
}
