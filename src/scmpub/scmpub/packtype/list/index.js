 ...
 * @Last Modified time: 2021-03-15 16:04:44
 */
...
class PackType extends Component {
	constructor(props) {
		...
		initLang(this, [ '4001packtype' ], 'scmpub', initTemplate.bind(this, this.props));
	}
	/**
	 * 主组织编辑事件
	 * @param {*} event 
				...
				<NCAffix>
					<NCDiv areaCode={NCDiv.config.HEADER} className="nc-bill-header-area">
						<div className="header-title-search-area">
							...
							<MainOrgRef
								ref="mainOrg"
								placeholder={getLangByResId(this, '4001PACKTYPE-000010')} /* 国际化处理： 公司*/ /* 国际化处理： 公司*/
								...
								refName={getLangByResId(this, '4001PACKTYPE-000010')} /* 国际化处理： 公司*/ /* 国际化处理： 公司*/
								required={true}
