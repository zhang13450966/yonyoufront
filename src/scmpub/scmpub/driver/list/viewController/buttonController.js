 ...
 * @Last Modified time: 2020-12-22 18:49:19
 */
import { AREA, FILED, STATUS } from '../../constance';
import { getLangByResId } from '../../../../../scmpub/scmpub/pub/tool/multiLangUtil';
function setDeleteStatus() {
	let status = this.props.editTable.getStatus(AREA.listTable);
	if (status == STATUS.browse) {
		this.props.button.setPopContent(FILED.Delete, getLangByResId(this, '4001DRIVER-000004')); /* 国际化处理： 确认要删除吗？*/
	} else {
...
export { setEditStatusButton, setAddStatusButton, setBrowseStatusButton, lineSelected, setDeleteStatus };
