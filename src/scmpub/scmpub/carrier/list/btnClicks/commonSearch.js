 ...
 * @Last Modified time: 2020-12-30 16:33:28
 */
import { ajax } from 'nc-lightapp-front';
import { URL, AREA, PAGEID, CARRIERDATASOURCE, FILED } from '../../constance';
		...
		ajax({
			...
			success: (res) => {
				if (res && res.data) {
					...
					if (isRefresh) {
						showSuccessInfo(getLangByResId(this, '4001CARRIER-000021')); /* 国际化处理： 刷新成功！*/
					} else {
						if (isToast) {
							showSuccessInfo(getLangByResId(this, '4001CARRIER-000022')); /* 国际化处理： 查询成功!*/
						}
					}
				} else if (!res.data) {
