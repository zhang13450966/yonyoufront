 ...
 * @Last Modified time: 2020-12-29 13:56:07
 */
	...
	showWarningDialog(getLangByResId(this, '4001CARRIER-000016'), getLangByResId(this, '4001CARRIER-000017'), {
		...
		beSureBtnClick: () => {
			this.props.form.setFormItemsValue(AREA.card_head, {
				[HEADFILED.bsealflag]: {
					value: true,
					display: getLangByResId(this, '4001CARRIER-000018') /* 国际化处理： 是*/
				}
			});
			...
			ajax({
				...
				success: (res) => {
					if (res.data && res.data.card_head) {
						...
						showSuccessInfo(getLangByResId(this, '4001CARRIER-000019')); /* 国际化处理： 停用成功!*/
