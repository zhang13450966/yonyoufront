...
class MoveButton extends Component {
    render() {
        ...
        if (direction === 'horizontal') {
            ...
            const moveToRightButton =
                <Button size="sm" className="transfer-operation-button to-right" disabled={!right.active} onClick={right.move}>
                    ...
                    >
                        ...
                        >{right.text}<i className="iconfont icon-chuansuo-you"></i></span>}</Tooltip>
                </Button>;
            ...
            const moveToLeftButton = <Button size="sm" className="transfer-operation-button to-left" disabled={!left.active} onClick={left.move}>
                <Tooltip
                    placement="top"
            ...
            const moveAllToLeftButton =
                <Button size="sm" className="transfer-operation-button all-to-left" disabled={!allLeft.active} onClick={allLeft.move}>
                    <Tooltip
                        placement="top"
