...
/* harmony export */ });
/* unused harmony exports base_path, COLS_EDITABLE */
/**
* @description: 常量
*/ //应用编码
...
// EXTERNAL MODULE: external "nc-lightapp-front"
var external_nc_lightapp_front_ = __webpack_require__(5118);
// EXTERNAL MODULE: ./src/hpf/hpfc/m0z10301/list/index.js + 5 modules
var list = __webpack_require__(7132);
;// CONCATENATED MODULE: ./src/hpf/hpfc/m0z10301/main/router.js


/**
* @description: 页面路由
* 保留注释 webpackChunkName:项目名/模块名/组件名/...
*/ const card = (0,external_nc_lightapp_front_.asyncComponent)(()=>Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 9594)));
const routes = [
    {
        path: '/',
...
;// CONCATENATED MODULE: ./src/hpf/hpfc/m0z10301/main/index.js
...
//# sourceMappingURL=index.a4048225.js.map