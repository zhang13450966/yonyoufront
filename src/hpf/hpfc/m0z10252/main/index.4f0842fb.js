...
;// CONCATENATED MODULE: ./src/hpf/hpfc/m0z10252/main/Utils.js
...
;// CONCATENATED MODULE: ./src/hpf/hpfc/m0z10252/main/index.js
/****************************************************************************************************
 *
 * 代码目录:
 *      目录结尾不带L和P的是当前节点的目录
...
const URLS = {
    // 请求路径
    addUrl: '/nccloud/hpf/drugclass/AddDrugclassVOAction.do',
    // 新增时请求默认值 Action
    saveUrl: '/nccloud/hpf/drugclass/SaveDrugclassVOAction.do',
    // 保存 Action
    listUrl: '/nccloud/hpf/drugclass/ListDrugclassVOAction.do',
    // 查询 Action
    downUrl: '/nccloud/hpf/drugclass/DownloadDrugclassVOAction.do'
};
    ...
    /** 渲染方法 */ render() {
        ...
        /** 渲染单表应用页面 */ let renderList = ()=>{
            ...
            return /*#__PURE__*/ external_root_React_var_React_commonjs_react_commonjs2_react_amd_react_default().createElement("div", {
                ...
                __source: {
                    fileName: "D:\\yonyou\\hotwebs\\src\\hpf\\hpfc\\m0z10252\\main\\index.js",
                    lineNumber: 527,
                    columnNumber: 17
                },
                __self: this
    ...
    */ main_defineProperty(this, "onDownload", ()=>{
     ...
     */ main_defineProperty(this, "onAfterEvent", (props, moduleId, key, value, changedrows, index, record)=>{
         ...
         */ this.config = {
            ...
            moduleId: 'M0Z10252',
            // 多语模块
            title: props.getSearchParam('n') || '来源药品分类档案',
            // 单据标题
 ...
 */ ApplicationPage = (0,external_nc_lightapp_front_.createPage)({
    ...
    billinfo: {
        billtype: 'grid',
        pagecode: 'M0Z10252_DrugclassVO',
        bodycode: 'DrugclassVOTable'
    },
...
//# sourceMappingURL=index.4f0842fb.js.map