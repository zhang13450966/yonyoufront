...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["hpf/hpfc/m0z10255/main/index"] = factory(require("react"), require("react-dom"), require("nc-lightapp-front"), require("uap/common/components/ExcelOutput/index"), require("uap/common/components/excelImportconfig/index"), require("uap/common/components/NCUploader/index"), require("uap/common/components/ApproveDetail/index"), require("uap/common/components/approvalTrans/index"), require("hpf/refer/hpfrefs/HpfEntryConfigGridRef/index"));
	else
		root["hpf/hpfc/m0z10255/main/index"] = factory(root["React"], root["ReactDOM"], root["nc-lightapp-front"], root["uap/common/components/ExcelOutput/index"], root["uap/common/components/excelImportconfig/index"], root["uap/common/components/NCUploader/index"], root["uap/common/components/ApproveDetail/index"], root["uap/common/components/approvalTrans/index"], root["hpf/refer/hpfrefs/HpfEntryConfigGridRef/index"]);
...
;// CONCATENATED MODULE: ./src/hpf/hpfc/m0z10255/main/Utils.js
...
;// CONCATENATED MODULE: ./src/hpf/hpfc/m0z10255/main/index.js
/****************************************************************************************************
 *
 * 代码目录:
 *      目录结尾不带L和P的是当前节点的目录
...
const URLS = {
    // 请求路径
    addUrl: '/nccloud/hpf/medservproclassfirlev/AddMedServProClassFirLevVOAction.do',
    // 新增时请求默认值 Action
    saveUrl: '/nccloud/hpf/medservproclassfirlev/SaveMedServProClassFirLevVOAction.do',
    // 保存 Action
    listUrl: '/nccloud/hpf/medservproclassfirlev/ListMedServProClassFirLevVOAction.do',
    // 查询 Action
    downUrl: '/nccloud/hpf/medservproclassfirlev/DownloadMedServProClassFirLevVOAction.do'
};
...
const FIELDS = {
    // 字段编码
    PK_ORG: 'pk_org',
    PRIMARYKEY: 'pk_medservproclassfirlev'
};
// 编辑模式变量
    ...
    /** 渲染方法 */ render() {
        ...
        /** 渲染单表应用页面 */ let renderList = ()=>{
            ...
            return /*#__PURE__*/ external_root_React_var_React_commonjs_react_commonjs2_react_amd_react_default().createElement("div", {
                ...
                __source: {
                    fileName: "D:\\yonyou\\hotwebs\\src\\hpf\\hpfc\\m0z10255\\main\\index.js",
                    lineNumber: 527,
                    columnNumber: 17
                },
                __self: this
...
     */ main_defineProperty(this, "createState", ()=>{
            let state = {
                ...
                search: {
                    // 查询区
                    area: 'MedServProClassFirLevVOQuery',
                    // 查询区域编码
                    showSearchBtn: false,
                    showClearBtn: false,
                    showAdvBtn: false,
                ...
                table: {
                    // 表格区域
                    area: 'MedServProClassFirLevVOTable',
                    // 表格区域编码
                    useFixedHeader: true,
                    adaptionHeight: true,
                    // 自动托底
    ...
    */ main_defineProperty(this, "onDownload", ()=>{
     ...
     */ main_defineProperty(this, "onAfterEvent", (props, moduleId, key, value, changedrows, index, record)=>{
         ...
         */ this.config = {
            ...
            moduleId: 'M0Z10255',
            // 多语模块
            title: props.getSearchParam('n') || '来源医疗服务项目分类一级',
            // 单据标题
         ...
         */ this.props.use.search('MedServProClassFirLevVOQuery');
        this.props.use.editTable('MedServProClassFirLevVOTable');
        /**
         * 加载NCC资源
         * 1.包含单据模板、按钮等平台定义的资源
         * 2.加载多语资源文件
 ...
 */ ApplicationPage = (0,external_nc_lightapp_front_.createPage)({
    ...
    billinfo: {
        billtype: 'grid',
        pagecode: 'M0Z10255_MedServProClassFirLevVO',
        bodycode: 'MedServProClassFirLevVOTable'
    },
    mutiLangCode: 'M0Z10255'
})(ApplicationPage);
...
//# sourceMappingURL=index.1dd99bea.js.map