...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["hpf/hpfc/m0z10207/main/index"] = factory(require("react"), require("react-dom"), require("nc-lightapp-front"));
	else
		root["hpf/hpfc/m0z10207/main/index"] = factory(root["React"], root["ReactDOM"], root["nc-lightapp-front"]);
...
;// CONCATENATED MODULE: ./src/hpf/hpfc/m0z10207/action/action.js
...
var treeId = 'chargetypeTree';
//树组件Id
var formId = 'chargetype';
//卡片组件Id
var pageCode = "hpf_chargetype";
// 小应用页面编码
var primaryKey = 'pk_chargetype';
// 主键
var fatherKey = 'father_pk';
//上级主键
const searchid = 'search';
var urlArray = {
    loadTreeDataUrl: "/nccloud/hpf/chargetype/queryChargetypeTree.do",
    queryCardUrl: "/nccloud/hpf/chargetype/queryChargetypeCard.do",
    saveCardUrl: '/nccloud/hpf/chargetype/saveChargetype.do',
    delTreeNodeUrl: '/nccloud/hpf/chargetype/deleteChargetype.do',
    downUrl: '/nccloud/hpf/chargetype/chargetypeDown.do'
};
...
*/ function onAddTreeNode(selectNode) {
    ...
    if (this.state.pk_org == "") {
        (0,external_nc_lightapp_front_.toast)({
            content: this.state.json['M0Z10207-000034'],
            color: 'warning'
        });
...
*/ function onEditTreeNode(selectedTreeNode) {
    if (selectedTreeNode.nodeData.isDown == 1) {
        (0,external_nc_lightapp_front_.toast)({
            content: this.state.json['M0Z10207-000035'],
            color: 'warning'
        });
    ...
    /****未选中提示***/ if (!selectedTreeNode) {
        (0,external_nc_lightapp_front_.toast)({
            content: this.state.json['M0Z10207-000012'],
            color: 'warning'
        });
        //默认top/* 国际化处理： 请选中需要编辑的节点*/
        return;
...
*/ function onDeleteTreeNode(selectedTreeNode) {
    if (!selectedTreeNode) {
        (0,external_nc_lightapp_front_.toast)({
            content: this.state.json['M0Z10207-000014'],
            color: 'warning'
        });
    ...
    if (selectedTreeNode.refpk == this.root.refpk) {
        (0,external_nc_lightapp_front_.toast)({
            content: this.state.json['M0Z10207-000015'],
            color: 'warning'
        });
        //默认top/* 国际化处理： 根节点不能删除*/
        return;
    }
    let message = this.state.json['M0Z10207-000016'];
    /* 国际化处理： 确认要删除所选数据吗？*/ (0,external_nc_lightapp_front_.promptBox)({
        color: 'warning',
        // 提示类别默认"success"， "success"/"info"/"warning"/"danger",非必输
        title: this.state.json['M0Z10207-000017'],
        ...
        beSureBtnName: this.state.json['M0Z10207-000006'],
        // 确定按钮名称, 默认为"确定",非必输/* 国际化处理： 确定*/
        cancelBtnName: this.state.json['M0Z10207-000007'],
...
*/ function onCancelButtonClick() {
    (0,external_nc_lightapp_front_.promptBox)({
        color: 'warning',
        // 提示类别默认"success"， "success"/"info"/"warning"/"danger",非必输
        title: this.state.json['M0Z10207-000021'],
        // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 确认取消*/
        content: this.state.json['M0Z10207-000022'],
...
*/ function onRefreshButtonClick() {
    loadTreeData.call(this, ()=>{
        ...
        (0,external_nc_lightapp_front_.toast)({
            content: this.state.json['M0Z10207-000028'],
            color: 'success'
        });
...
* */ function loadTreeData(callback) {
    ...
    *************/ (0,external_nc_lightapp_front_.ajax)({
        ...
        success: (result)=>{
            if (result.success) {
                this.root.refname = this.state.json['M0Z10207-000000'];
                this.root.title = this.state.json['M0Z10207-000000'];
                let data = [
...
function doSave(callback) {
    ...
    **************************************************/ let formData = this.props.form.getAllFormValue(formId);
    //获得表单信息
    // if (selectedTreeNode.nodeData.isDown == 1) { //下载的不允许更新
    //     toast({ content: this.state.json['M0Z10207-000031'], color: 'warning' });/* 国际化处理： 保存成功*/
    //     return
    // }
    // 针对停启用，之后可以去掉
    ...
    this.props.validateToSave(requestParam, ()=>{
        (0,external_nc_lightapp_front_.ajax)({
            ...
            success: (result)=>{
                if (result.success) {
                    (0,external_nc_lightapp_front_.toast)({
                        content: this.state.json['M0Z10207-000029'],
                        color: 'success'
                    });
...
function doDel(selectedTreeNode) {
    ...
    let requestParam = {
        pk_chargetype: selectedTreeNode.refpk,
    ...
    (0,external_nc_lightapp_front_.ajax)({
        ...
        success: (result)=>{
            if (selectedTreeNode.nodeData.isDown == 1) {
                (0,external_nc_lightapp_front_.toast)({
                    content: this.state.json['M0Z10207-000030'],
                    color: 'warning'
                });
                ...
                if (result.success) {
                    ...
                    (0,external_nc_lightapp_front_.toast)({
                        content: this.state.json['M0Z10207-000018'],
                        color: 'success'
                    });
...
* */ function loadTreeDataByOrg(data, callback) {
    ...
    for (var item of meta['chargetype'].items){
        if (item.refcode) {
    ...
    let excelPkOrg;
    if (this.props.search.getAllSearchData(searchid)) {
        //查询条件 不为空时
    ...
    let excelimportconfig = excelImportconfig_default()(this.props, 'hpf', 'chargetype', true, '', {
...
;// CONCATENATED MODULE: ./src/hpf/hpfc/m0z10207/event/event.js

var event_treeId = 'chargetypeTree';
//树组件Id
var event_formId = 'chargetype';
//卡片组件Id
/**
* 点击树节点
* @param refpk
...
*/ function onAfterFormEvent(props, moduleId, key, value, index) {
    if (key === 'syscode') {
        let sysValue = value.value;
        //系统编码参照过滤
        let metas = props.meta.getMeta();
        for (var item of metas['chargetype'].items){
            if (item.refcode) {
                if (item.attrcode === 'pk_sssrxm') {
                    //来源系统过滤
                    item.queryCondition = ()=>{
...
*/ function onBeforeFormEvent(props, moduleId, key, value, data) {
    if (key === 'pk_sssrxm') {
        let sysValue = data.syscode.value;
        let metas = props.meta.getMeta();
        for (var item of metas['chargetype'].items){
            if (item.refcode) {
                if (item.attrcode === 'pk_sssrxm') {
...
;// CONCATENATED MODULE: ./src/hpf/hpfc/m0z10207/main/index.js
...
var excelPageCode;
var excelPkOrg;
var main_treeId = 'chargetypeTree';
//树组件Id
var main_formId = 'chargetype';
//卡片组件Id
var main_pageCode = "M0Z10207_chargetype";
// 小应用页面编码
var multiInit = 'M0Z10207';
//多语资源编码
var domainName = 'hpf';
// 模块编码
/**
...
*/ let comp = class comp extends external_root_React_var_React_commonjs_react_commonjs2_react_amd_react_.Component {
        ...
        */ componentWillMount() {
        ...
        let callback = (json, status, inlt)=>{
            this.setState({
                ...
                this.root.refname = this.root.title = this.state.json['M0Z10207-000000'];
                this.initTemplate(this.props, ()=>{
                    loadTreeData.bind(this)();
                });
            });
    ...
    */ render() {
        ...
        return /*#__PURE__*/ external_root_React_var_React_commonjs_react_commonjs2_react_amd_react_default().createElement("div", {
            ...
            __source: {
                fileName: "D:\\yonyou\\hotwebs\\src\\hpf\\hpfc\\m0z10207\\main\\index.js",
                lineNumber: 281,
                columnNumber: 13
            },
            __self: this
            ...
            title: this.state.json['M0Z10207-000023'],
    ...
    */ main_defineProperty(this, "initTemplate", (props, callback)=>{
            ...
            (data)=>{
                if (data) {
                    if (data.template) {
                        ...
                        // if (item.attrcode === 'pk_sssrxm') { //收入项目
                        //     item.queryCondition = () => {
                        //         return {
                        //             pk_org: this.state.pk_org
                        //         };
                    ...
                    let excelimportconfig = excelImportconfig_default()(props, 'hpf', 'chargetype', true, '', {
                        appcode: excelAppCode,
                        pk_org: excelPkOrg,
                        pagecode: excelPageCode
                    }, ()=>{
        ...
        this.root = {
            "isleaf": false,
            "key": "root",
            "title": this.state.json['M0Z10207-000000'],
            /* 国际化处理： 职务类别*/ "id": "root",
            "innercode": "root",
            "pid": "",
            "refname": this.state.json['M0Z10207-000000'],
            /* 国际化处理： 职务类别*/ "refpk": "~"
        };
        afterInit(this);
    }
...
//# sourceMappingURL=index.db6a701d.js.map