...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["hpf/hpfc/m0z10206/main/index"] = factory(require("react"), require("react-dom"), require("nc-lightapp-front"));
	else
		root["hpf/hpfc/m0z10206/main/index"] = factory(root["React"], root["ReactDOM"], root["nc-lightapp-front"]);
...
var excelImportconfig = __webpack_require__(5260);
var excelImportconfig_default = /*#__PURE__*/__webpack_require__.n(excelImportconfig);
;// CONCATENATED MODULE: ./src/hpf/hpfc/m0z10206/action/action.js
...
var treeId = 'incometypeTree';
//树组件Id
var formId = 'incometype';
//卡片组件Id
var pageCode = "hpf_incometype";
// 小应用页面编码
var primaryKey = 'pk_incometype';
// 主键
var fatherKey = 'father_pk';
//上级主键
const searchid = 'search';
var urlArray = {
    loadTreeDataUrl: "/nccloud/hpf/incometype/queryIncometypeTree.do",
    queryCardUrl: "/nccloud/hpf/incometype/queryIncometypeCard.do",
    saveCardUrl: '/nccloud/hpf/incometype/saveIncometype.do',
    delTreeNodeUrl: '/nccloud/hpf/incometype/deleteIncometype.do',
    downUrl: '/nccloud/hpf/incometype/incometypeDown.do'
};

var initfn = {};
/**
* 树节点新增
*/ function onAddTreeNode(selectNode) {
    //判断查询去条件是否为空
    if (this.state.pk_org == "") {
        (0,external_nc_lightapp_front_.toast)({
            content: this.state.json['M0Z10206-000034'],
            color: 'warning'
        });
        /* 国际化处理： 下载的不允许删除！,提示*/ return;
    }
    HideButtonOnEditOrAdd.call(this);
    //选中树节点
...
/**
* 树节点编辑
*/ function onEditTreeNode(selectedTreeNode) {
    if (selectedTreeNode.nodeData.isDown == 1) {
        (0,external_nc_lightapp_front_.toast)({
            content: this.state.json['M0Z10206-000035'],
            color: 'warning'
        });
        //默认top/* 国际化处理： 请选中需要编辑的节点*/
        return;
    }
    //判断查询去条件是否为空
    if (this.state.pk_org == "") {
    ...
    /****未选中提示***/ if (!selectedTreeNode) {
        (0,external_nc_lightapp_front_.toast)({
            content: this.state.json['M0Z10206-000012'],
            color: 'warning'
        });
        //默认top/* 国际化处理： 请选中需要编辑的节点*/
        return;
    ...
    loadFormData.call(this, selectedTreeNode.refpk, ()=>{
        ...
        HideButtonOnEditOrAdd.call(this);
        HideButtonOnEdit.call(this);
    });
}
function afterInit() {}
/**
* 树节点删除
*/ function onDeleteTreeNode(selectedTreeNode) {
    if (!selectedTreeNode) {
        (0,external_nc_lightapp_front_.toast)({
            content: this.state.json['M0Z10206-000014'],
            color: 'warning'
        });
        //默认top/* 国际化处理： 请选中需要删除的节点*/
        return;
    }
    if (selectedTreeNode.refpk == this.root.refpk) {
        (0,external_nc_lightapp_front_.toast)({
            content: this.state.json['M0Z10206-000015'],
            color: 'warning'
        });
        //默认top/* 国际化处理： 根节点不能删除*/
        return;
    }
    let message = this.state.json['M0Z10206-000016'];
    /* 国际化处理： 确认要删除所选数据吗？*/ (0,external_nc_lightapp_front_.promptBox)({
        color: 'warning',
        // 提示类别默认"success"， "success"/"info"/"warning"/"danger",非必输
        title: this.state.json['M0Z10206-000017'],
        // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 确认删除*/
        content: message,
        // 提示内容,非必输
        noFooter: false,
        ...
        beSureBtnName: this.state.json['M0Z10206-000006'],
        // 确定按钮名称, 默认为"确定",非必输/* 国际化处理： 确定*/
        cancelBtnName: this.state.json['M0Z10206-000007'],
        // 取消按钮名称, 默认为"取消",非必输/* 国际化处理： 取消*/
...
/**
* 保存新增
*/ function onSaveAddButtonClick() {
    doSave.call(this, (data)=>{
        afterSaveAdd.call(this, data, ()=>{
            doAdd.call(this, ()=>{
                updateStatus.call(this);
            });
        });
...
*/ function onCancelButtonClick() {
    (0,external_nc_lightapp_front_.promptBox)({
        color: 'warning',
        // 提示类别默认"success"， "success"/"info"/"warning"/"danger",非必输
        title: this.state.json['M0Z10206-000021'],
        // 提示标题, 默认不同类别下分别为："已成功"/"帮助信息"/"请注意"/"出错啦",非必输/* 国际化处理： 确认取消*/
        content: this.state.json['M0Z10206-000022'],
        // 提示内容,非必输/* 国际化处理： 是否确认要取消？*/
        noFooter: false,
        // 是否显示底部按钮(确定、取消),默认显示(false),非必输
        noCancelBtn: false,
        // 是否显示取消按钮,，默认显示(false),非必输
        ...
        cancelBtnName: this.state.json['M0Z10206-000007'],
        // 取消按钮名称, 默认为"取消",非必输/* 国际化处理： 取消*/
        beSureBtnClick: doCancel.bind(this)
    });
}
// 确定按钮点击调用函数,非必输
/**
...
*/ function onRefreshButtonClick() {
    loadTreeData.call(this, ()=>{
        ...
        (0,external_nc_lightapp_front_.toast)({
            content: this.state.json['M0Z10206-000028'],
            color: 'success'
        });
        /* 国际化处理： 刷新成功*/ updateStatus.call(this);
    });
}
/**
* 刷新
...
* */ function loadTreeData(callback) {
    ...
    *************/ let requestParam = {
        ...
        syscode: this.props.search.getSearchValByField("search", "syscode").value.firstvalue
    };
    /*************
    * ajax请求 加载树数据
    *************/ (0,external_nc_lightapp_front_.ajax)({
        ...
        success: (result)=>{
            if (result.success) {
                this.root.refname = this.state.json['M0Z10206-000000'];
                this.root.title = this.state.json['M0Z10206-000000'];
                let data = [
                    Object.assign(_objectSpread({}, this.root), {
...
function doAdd(callback) {
    ...
    this.props.form.setFormItemsValue(formId, {
        [fatherKey]: {
            value: selectNode.refpk,
            display: selectNode.refname
        }
    });
...
function doSave(callback) {
    ...
    */ formData.areacode = formId;
    ...
    //设置状态
    //formData.rows[0].values.pk_org.value = this.props.search.getAllSearchData(searchid).conditions[0].value.firstvalue;
    //formData.pk_org.value=this.props.search.getAllSearchData(searchid).conditions[0].value.firstvalue
    formData.rows[0].values.pk_org.value = this.props.search.getSearchValByField("search", "pk_org").value.firstvalue;
    /***设置请求参数***/ requestParam = {
        model: formData,
        pageid: pageCode
    };
    //pageid : 我们导出的模板的名字  也就是 json数据的最外层的code值
    //ajax请求
    this.props.validateToSave(requestParam, ()=>{
        (0,external_nc_lightapp_front_.ajax)({
            ...
            success: (result)=>{
                if (result.success) {
                    (0,external_nc_lightapp_front_.toast)({
                        content: this.state.json['M0Z10206-000029'],
                        color: 'success'
                    });
                    /* 国际化处理： 保存成功*/ callback && callback.call(this, result.data);
                }
            }
        });
    }, {
...
function afterSave(data, callback) {
    ...
    ************************************/ let formData = this.props.form.getAllFormValue(formId);
    //获得表单信息
    let syscodeCode = formData.rows[0].values["syscode.code"].value;
    let syscodeName = formData.rows[0].values["syscode.name"].value;
    let fatherName = formData.rows[0].values.father_pk.display;
    var pk = null;
    if (formData.rows[0].values.hasOwnProperty(primaryKey)) {
        var pk = formData.rows[0].values[primaryKey].value;
    }
    //当前表单有pk:update 刷新父节点；没有pk:save 刷新当前节点
    /**
    ...
    */ let nonPk = !pk || pk === null || pk === '';
    ...
    //设置表单浏览态
    this.props.form.setFormStatus(formId, 'browse');
    //当手动录入时，系统编码和系统名称为空，回调时不显示，在此处设为默认的HRPG和手工录入
    data.form[formId].rows[0].values["syscode.code"] = {
        value: syscodeCode
    };
    data.form[formId].rows[0].values["syscode.name"] = {
        value: syscodeName
    };
    data.form[formId].rows[0].values["father_pk"] = {
        display: fatherName
    };
...
function afterSaveAdd(data, callback) {
    if (!data || data == null) return;
    /****判断刷新父节点，还是刷新选中节点****/ /************************************
    * 如果是新增，就刷新当前选中节点
    * 如果是编辑，就刷新当前节点的父节点
    ...
    */ let nonPk = !pk || pk === null || pk === '';
    ...
    this.props.syncTree.openNodeByPk(treeId, data.node[0].pid);
    //选中树节点
    this.props.syncTree.setNodeSelected(treeId, data.node[0].pid);
    //设置表单浏览态
    this.props.form.setFormStatus(formId, 'browse');
    //当手动录入时，系统编码和系统名称为空，回调时不显示，在此处设为默认的HRPG和手工录入
    data.form[formId].rows[0].values["syscode.code"] = {
...
function doDel(selectedTreeNode) {
    ...
    let requestParam = {
        pk_incometype: selectedTreeNode.refpk,
    ...
    (0,external_nc_lightapp_front_.ajax)({
        ...
        success: (result)=>{
            if (selectedTreeNode.nodeData.isDown == 1) {
                (0,external_nc_lightapp_front_.toast)({
                    content: this.state.json['M0Z10206-000030'],
                    color: 'warning'
                });
            } else /* 国际化处理： 下载的不允许删除！,提示*/ {
                if (result.success) {
                    this.props.form.EmptyAllFormValue(formId);
                    //调用异步树的接口，删除该树节点
                    this.props.asyncTree.delTreeData(treeId, selectedTreeNode.refpk);
                    (0,external_nc_lightapp_front_.toast)({
                        content: this.state.json['M0Z10206-000018'],
                        color: 'success'
                    });
                    /* 国际化处理： 删除成功！,提示*/ updateStatus.call(this);
                    //删除后调用
                    this.props.syncTree.delNodeSuceess(treeId, selectedTreeNode.refpk);
                    //展开父节点
                    this.props.syncTree.openNodeByPk(treeId, selectedTreeNode.pid);
                    //选中父节点
                    this.props.syncTree.setNodeSelected(treeId, selectedTreeNode.pid);
                    //设置表单浏览态
                    this.props.form.setFormStatus(formId, 'browse');
                }
            }
...
function loadFormData(refpk, callback) {
...
//更新按钮状态
function HideButtonOnEditOrAdd() {
    let buttonVisible = {
        Down: false,
        ImportGroup: false,
        import_excel: false,
...
function updateButtonStatus() {
    ...
    let buttonVisible = {
        ...
        Down: formStatus === 'browse',
        Import: formStatus === 'browse',
        import_excel: formStatus === 'browse',
        export_excel: formStatus === 'browse'
    };
    let buttonDisabled = {
        Save: formStatus === 'browse',
        SaveAdd: formStatus === 'browse',
...
/**
* 导出模板
*/ function onExportTempButtonClick() {
    this.setState({
        pks: []
    }, ()=>{
...
/**
* 通过组织筛选
* */ function loadTreeDataByOrg(data, callback) {
    //系统编码参照过滤
    let meta = this.props.meta.getMeta();
    for (var item of meta['incometype'].items){
        if (item.refcode) {
            if (item.attrcode === 'syscode') {
                //来源系统过滤
                item.queryCondition = ()=>{
                    return {
                        pk_org: data.search.getSearchValByField("search", "pk_org").value.firstvalue
                    };
                };
            }
        }
    ...
    //导入按钮 单据类型命名自定义，但要与xml配置文件名一致
    let excelAppCode = this.props.getAppCode();
    let excelPageCode = this.props.getPageCode();
    let excelPkOrg = data.search.getSearchValByField("search", "pk_org").value.firstvalue;
    if (this.state.pk_org != excelPkOrg) {
        this.props.search.setSearchValByField(searchid, 'syscode', {
            display: '',
            value: ''
        });
    }
    ...
    let excelimportconfig = excelImportconfig_default()(this.props, 'hpf', 'incomeType', true, '', {
        appcode: excelAppCode,
        pk_org: excelPkOrg,
        pagecode: excelPageCode
    }, ()=>{
        if (excelPkOrg != "") {
            loadTreeData.call(this, ()=>{
                this.props.form.EmptyAllFormValue(formId);
    ...
    this.props.button.setUploadConfig("import_excel", excelimportconfig);
    // /**************
    // * 构造请求参数
    // *************/
    let requestParam = {
        pk_org: data.search.getSearchValByField("search", "pk_org").value.firstvalue,
        syscode: data.search.getSearchValByField("search", "syscode").value.firstvalue
    };
    /*************
    * ajax请求 加载树数据
    *************/ (0,external_nc_lightapp_front_.ajax)({
...
;// CONCATENATED MODULE: ./src/hpf/hpfc/m0z10206/event/event.js

var event_treeId = 'incometypeTree';
//树组件Id
var event_formId = 'incometype';
//卡片组件Id
/**
* 点击树节点
* @param refpk
*/ function onSelectTree(refpk) {
    if (!refpk || refpk === null) return;
    //编辑态  树节点操作无效  应该提供一个接口，编辑态任何操作都不能动
    if (this.props.form.getFormStatus(event_formId) === 'edit') return;
    if (refpk === '~') {
        //清空表单
        this.props.form.EmptyAllFormValue(event_formId);
        return;
    }
...
*/ function onMouseEnterEve(key) {
    ...
    if (key === this.root.refpk) {
        ...
        this.props.syncTree.hideIcon(event_treeId, key, obj);
    }
}
/**
* 表单编辑后事件
...
* @param value
* @param index
*/ function onAfterFormEvent(props, moduleId, key, value, index) {}
/**
* 表单编辑前事件
* @param {*} props
* @param {*} moduleId
...
* @param {*} value
* @param {*} data
*/ function onBeforeFormEvent(props, moduleId, key, value, data) {
    return true;
}
...
;// CONCATENATED MODULE: ./src/hpf/hpfc/m0z10206/main/index.js
...
//新的筛选
//import Org from '../../../../uapbd/refer/org/FinanceOrgTreeRef/index.js';
const { NCDiv  } = external_nc_lightapp_front_.base;
var main_treeId = 'incometypeTree';
//树组件Id
var main_formId = 'incometype';
//卡片组件Id
var main_pageCode = "M0Z10206_incometype";
// 小应用页面编码
var multiInit = 'M0Z10206';
//多语资源编码
var domainName = 'hpf';
// 模块编码
var excelAppCode;
...
/**
* 职务类别-全局
*/ let comp = class comp extends external_root_React_var_React_commonjs_react_commonjs2_react_amd_react_.Component {
    /**
        ...
        */ componentWillMount() {
        ...
        let callback = (json, status, inlt)=>{
            this.setState({
                ...
                this.root.refname = this.root.title = this.state.json['M0Z10206-000000'];
                this.initTemplate(this.props, ()=>{
                    loadTreeData.bind(this)();
                });
            });
    ...
    */ modifierMeta(props, meta) {
        //查询区参照过滤
        meta[main_searchid].items.map((item)=>{
    ...
    buttonClick(props, id) {
        switch(id){
            case 'Save':
                onSaveButtonClick.call(this);
                break;
            case 'SaveAdd':
                onSaveAddButtonClick.call(this);
                break;
            case 'Cancel':
                onCancelButtonClick.call(this);
                break;
            case 'Refresh':
            ...
            case 'Down':
                ...
                break;
            case 'export_excel':
                onExportTempButtonClick.call(this);
                break;
        }
    }
    /**
    ...
    * @returns {*}
    */ render() {
        const { syncTree , form , button , DragWidthCom , BillHeadInfo , search  } = this.props;
        ...
        return /*#__PURE__*/ external_root_React_var_React_commonjs_react_commonjs2_react_amd_react_default().createElement("div", {
            className: "nc-bill-tree-card",
            __source: {
                fileName: "D:\\yonyou\\hotwebs\\src\\hpf\\hpfc\\m0z10206\\main\\index.js",
                lineNumber: 274,
                columnNumber: 13
            },
            __self: this
            ...
            title: this.state.json['M0Z10206-000023'],
            /* 国际化处理： 职务类别-全局*/ showBackBtn: false,
            initShowBackBtn: false
        })), /* 新的筛选*/ /* <div className="search-box">
                        {Org({
                            ...this.state.org,
                            disabled: this.state.editMode,
                            fieldid: 'org_fieldid'
                        })}
                    </div> */ /*#__PURE__*/ external_root_React_var_React_commonjs_react_commonjs2_react_amd_react_default().createElement("div", {
            className: "search-area-selfdef",
            style: {
                width: '570px'
            },
            __source: {
            ...
            showAdvSearchPlanBtn: false,
            onAfterEvent: loadTreeDataByOrg.bind(this, this.props)
        })), /* 按钮组 btn-group*/ /*#__PURE__*/ external_root_React_var_React_commonjs_react_commonjs2_react_amd_react_default().createElement("div", {
            className: " btn-group",
            __source: {
                fileName: "D:\\yonyou\\hotwebs\\src\\hpf\\hpfc\\m0z10206\\main\\index.js",
                lineNumber: 307,
        ...
        }))), /* 树卡区域 */ /*#__PURE__*/ external_root_React_var_React_commonjs_react_commonjs2_react_amd_react_default().createElement("div", {
            className: "tree-card",
            __source: {
                fileName: "D:\\yonyou\\hotwebs\\src\\hpf\\hpfc\\m0z10206\\main\\index.js",
                lineNumber: 318,
            ...
            __self: this
        }, /*#__PURE__*/ external_root_React_var_React_commonjs_react_commonjs2_react_amd_react_default().createElement(DragWidthCom, {
            // 左树区域
            leftDom: /*#__PURE__*/ external_root_React_var_React_commonjs_react_commonjs2_react_amd_react_default().createElement("div", {
                className: "tree-area"
            }, createSyncTree({
                treeId: main_treeId,
                needEdit: true,
                ...
                onSelectEve: onSelectTree.bind(this),
                //选择
                onMouseEnterEve: onMouseEnterEve.bind(this),
                clickEditIconEve: onEditTreeNode.bind(this),
                //编辑点击 回调
                clickAddIconEve: onAddTreeNode.bind(this),
                //新增点击 回调
                clickDelIconEve: onDeleteTreeNode.bind(this),
                // 删除点击 回调
                showModal: false,
            ...
            //左侧区域dom
            // 右卡片区域
            rightDom: /*#__PURE__*/ external_root_React_var_React_commonjs_react_commonjs2_react_amd_react_default().createElement("div", {
                className: "card-area"
            }, createForm(main_formId, {
                cancelPSwitch: true,
                onAfterEvent: onAfterFormEvent.bind(this),
                onBeforeEvent: onBeforeFormEvent.bind(this)
            })),
            //右侧区域dom
            defLeftWid: "280px",
            __source: {
        ...
        /*#__PURE__*/ external_root_React_var_React_commonjs_react_commonjs2_react_amd_react_default().createElement((ExcelOutput_default()), main_objectSpreadProps(main_objectSpread({}, //导出组件
        this.props), {
            moduleName: "hpf",
            //模块名
            billType: "incometype",
            //单据类型  命名自定义，但要与xml配置文件名一致  
    ...
    constructor(props){
        props.use.form(main_formId);
        super(props);
        /**
    * 初始化：模板和按钮
    */ main_defineProperty(this, "initTemplate", (props, callback)=>{
            props.createUIDom({
                pagecode: main_pageCode
            }, //页面id
            (data)=>{
                if (data) {
                    if (data.template) {
                        if (data.context.pk_org != 'GLOBLE00000000000000') {
                            this.setState({
                        ...
                        // if (context.pk_org != 'GLOBLE00000000000000') {
                        //     var value = {
                        ...
                        // }
                        //根据个性化设置设置默认的业务单元
                        this.props.search.setSearchValByField(main_searchid, 'pk_org', {
                            display: this.state.org_Name,
                            value: this.state.pk_org
                        });
                        //系统编码参照过滤
                        let metas = this.props.meta.getMeta();
                        for (var item of metas['incometype'].items){
                            if (item.refcode) {
                                if (item.attrcode === 'syscode') {
                                    //来源系统过滤
                                    item.queryCondition = ()=>{
                    ...
                    //新的筛选
                    //  this.props.search.changeItemVisibleByField(searchid, 'pk_org', false);
                    //导入按钮 单据类型命名自定义，但要与xml配置文件名一致
                    excelAppCode = this.props.getAppCode();
                    //excelPkOrg = this.state.org.value.refpk;
                    excelPkOrg = this.props.search.getSearchValByField("search", "pk_org").value.firstvalue;
                    excelPageCode = this.props.getPageCode();
                    let excelimportconfig = excelImportconfig_default()(props, 'hpf', 'incomeType', true, '', {
                        appcode: excelAppCode,
                        pk_org: excelPkOrg,
                        pagecode: excelPageCode
                    }, ()=>{
                        onRefreshImport.call(this);
                    });
                    //导入完成后 执行刷新方法
                    props.button.setUploadConfig("import_excel", excelimportconfig);
                    callback && callback();
                }
            });
        });
        main_defineProperty(this, "updateButtonStatus", (status)=>{
        ...
        this.state = {
            ...
            //             this.props.search.setSearchValByField(searchid, 'pk_org', { display: this.state.org.value.refname, value: this.state.org.value.refpk });
            //            actions['loadTreeDataByOrg'].bind(this)();
            //         });
            //     }
            // },
            //*********************/
        ...
        this.root = {
            "isleaf": false,
            "key": "root",
            "title": this.state.json['M0Z10206-000000'],
            /* 国际化处理： 职务类别*/ "id": "root",
            "innercode": "root",
            "pid": "",
            "refname": this.state.json['M0Z10206-000000'],
            /* 国际化处理： 职务类别*/ "refpk": "~"
        };
        afterInit(this);
    }
};
let TreeForm = (0,external_nc_lightapp_front_.createPage)({
    billinfo: {
        billtype: 'form',
        pagecode: main_pageCode,
        bodycode: main_formId
    }
})(comp);
external_root_ReactDOM_var_ReactDOM_commonjs_react_dom_commonjs2_react_dom_amd_react_dom_default().render(/*#__PURE__*/ external_root_React_var_React_commonjs_react_commonjs2_react_amd_react_default().createElement(TreeForm, {
    __source: {
        fileName: "D:\\yonyou\\hotwebs\\src\\hpf\\hpfc\\m0z10206\\main\\index.js",
        lineNumber: 402,
        columnNumber: 17
...
//# sourceMappingURL=index.2a085947.js.map