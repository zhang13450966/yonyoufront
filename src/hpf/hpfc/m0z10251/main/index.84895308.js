...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["hpf/hpfc/m0z10251/main/index"] = factory(require("react"), require("react-dom"), require("nc-lightapp-front"), require("uap/common/components/ExcelOutput/index"), require("uap/common/components/excelImportconfig/index"), require("uap/common/components/NCUploader/index"), require("uap/common/components/ApproveDetail/index"), require("uap/common/components/approvalTrans/index"), require("hpf/refer/hpfrefs/HpfEntryConfigGridRef/index"));
	else
		root["hpf/hpfc/m0z10251/main/index"] = factory(root["React"], root["ReactDOM"], root["nc-lightapp-front"], root["uap/common/components/ExcelOutput/index"], root["uap/common/components/excelImportconfig/index"], root["uap/common/components/NCUploader/index"], root["uap/common/components/ApproveDetail/index"], root["uap/common/components/approvalTrans/index"], root["hpf/refer/hpfrefs/HpfEntryConfigGridRef/index"]);
...
;// CONCATENATED MODULE: ./src/hpf/hpfc/m0z10251/main/Utils.js
 ...
 */ const loadRefer = function(urls = []) {
    ...
    }) || []).map((refObj)=>new Promise((resolve, reject)=>{
            let { url , name  } = refObj;
            let jsname = url.includes(".") ? url.substring(0, url.length - 3) : url;
 ...
 */ const loadNCCResource = function(config) {
    ...
    //加载参照
    loadRefer(referObjs).then(()=>Promise.all([
            //加载模板
            loadTemplate(props, {
                pagecode,
                appcode
...
const FloatMultiple = function(f1, f2) {
    let m = 0, s1 = f1.toString(), s2 = f2.toString();
    try {
        m += s1.split(".")[1].length;
    } catch (e) {}
    try {
...
;// CONCATENATED MODULE: ./src/hpf/hpfc/m0z10251/main/index.js
/****************************************************************************************************
 *
 * 代码目录:
 *      目录结尾不带L和P的是当前节点的目录
...
const URLS = {
    // 请求路径
    addUrl: '/nccloud/hpf/materialclass/AddMaterialClassVOAction.do',
    // 新增时请求默认值 Action
    saveUrl: '/nccloud/hpf/materialclass/SaveMaterialClassVOAction.do',
    // 保存 Action
    listUrl: '/nccloud/hpf/materialclass/ListMaterialClassVOAction.do',
    // 查询 Action
    downUrl: '/nccloud/hpf/materialclass/DownloadMaterialClassVOAction.do'
};
//下载 Action  add by suqc
const ACTIONS = {
    // 按钮编码
    DOWNLOAD: 'Download',
    //下载 add by suqc
...
let ApplicationPage = class ApplicationPage extends external_root_React_var_React_commonjs_react_commonjs2_react_amd_react_.Component {
    /** 渲染方法 */ render() {
        ...
        /** 渲染单表应用页面 */ let renderList = ()=>{
            ...
            return /*#__PURE__*/ external_root_React_var_React_commonjs_react_commonjs2_react_amd_react_default().createElement("div", {
                ...
                __source: {
                    fileName: "D:\\yonyou\\hotwebs\\src\\hpf\\hpfc\\m0z10251\\main\\index.js",
                    lineNumber: 529,
                    columnNumber: 17
                },
                __self: this
                ...
                __self: this
            }, " ", /* 列表区 */ this.props.editTable.createEditTable(table.area, main_objectSpread({}, table))), //add by suqc
            createModal('selds', {
                title: '选择来源系统',
                className: 'selds',
     ...
     */ main_defineProperty(this, "onAfterEvent", (props, moduleId, key, value, changedrows, index, record)=>{
         ...
         */ this.config = {
            ...
            moduleId: 'M0Z10251',
            // 多语模块
            title: props.getSearchParam('n') || '来源物料分类档案',
            // 单据标题
         ...
         */ this.props.use.search('MaterialClassVOQuery');
        this.props.use.editTable('MaterialClassVOTable');
        /**
         * 加载NCC资源
         * 1.包含单据模板、按钮等平台定义的资源
         * 2.加载多语资源文件
 ...
 */ ApplicationPage = (0,external_nc_lightapp_front_.createPage)({
    ...
    billinfo: {
        billtype: 'grid',
        pagecode: 'M0Z10251_MaterialClassVO',
        bodycode: 'MaterialClassVOTable'
    },
    mutiLangCode: 'M0Z10251'
})(ApplicationPage);
...
//# sourceMappingURL=index.84895308.js.map