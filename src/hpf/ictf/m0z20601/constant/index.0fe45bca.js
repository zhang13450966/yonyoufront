...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["hpf/ictf/m0z20601/constant/index"] = factory();
	else
		root["hpf/ictf/m0z20601/constant/index"] = factory();
})(self, () => {
...
* @description: 常量
*/ //应用编码
const APPCODE = 'M0Z20601';
//单据类型
const BILL_TYPE_CODE = 'HPF1';
/**
* @description: 多语
 ...
 * 列表
 */ const LIST = {
    page_title: 'M0Z20601-000011',
    //页面标题 /* 国际化处理： 投融资费用*/
    page_code: 'M0Z20601_LIST',
    //页面编码
...
//url
const REQUEST_URL = {
    save: `/nccloud/hpf/ictf/saveClinicDepositHeadVO.do`,
    //保存
    delete: `/nccloud/hpf/ictf/deleteClinicDepositHeadVO.do`,
    //删除
    queryCard: `/nccloud/hpf/ictf/querycardClinicDepositHeadVO.do`,
    //卡片查询
    queryList: `/nccloud/hpf/ictf/querypageClinicDepositHeadVO.do`,
    //列表查询
    queryListByPks: `/nccloud/hpf/ictf/querypagebypkClinicDepositHeadVO.do`,
    //列表分页查询
    commit: `/nccloud/hpf/ictf/commitClinicDepositHeadVO.do`,
    //提交
    unCommit: `/nccloud/hpf/ictf/uncommitClinicDepositHeadVO.do`,
    //收回
    toCard: '/card',
    toList: '/list',
    down: `/nccloud/hpf/ictf/downClinicDeposit.do`,
    //从中间库下载
    linkquery: '/nccloud/hpf/ictf/clinicDepositLinkQueryVoucher.do',
    //联查凭证
    makebill: '/nccloud/hpf/ictf/clinicDepositMakebill.do',
    //制单
    Print: '/nccloud/hpf/ictf/clinicDepositPrint.do',
    //打印
...
//主属性字段名
const PRIMARY_KEY = {
    head_id: 'pk_clinicdeposit',
    //表头主键字段名
    body_id: 'pk_clinicdeposit_b',
    //表体主键字段名
    bill_no: 'billno',
    //单据编号字段名
    id: 'id'
...
//# sourceMappingURL=index.0fe45bca.js.map