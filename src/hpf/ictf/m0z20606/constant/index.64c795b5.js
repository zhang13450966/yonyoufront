...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["hpf/ictf/m0z20606/constant/index"] = factory();
	else
		root["hpf/ictf/m0z20606/constant/index"] = factory();
})(self, () => {
...
* @description: 常量
*/ //应用编码
const APPCODE = 'M0Z20606';
//单据类型
const BILL_TYPE_CODE = 'HPF6';
/**
* @description: 多语
 ...
 * 列表
 */ const LIST = {
    page_title: 'M0Z20606-000011',
    //页面标题 /* 国际化处理： 投融资费用*/
    page_code: 'M0Z20606_LIST',
    //页面编码
...
//url
const REQUEST_URL = {
    save: `/nccloud/hpf/ictf/saveHospPrepayHeadVO.do`,
    //保存
    delete: `/nccloud/hpf/ictf/deleteHospPrepayHeadVO.do`,
    //删除
    queryCard: `/nccloud/hpf/ictf/querycardHospPrepayHeadVO.do`,
    //卡片查询
    queryList: `/nccloud/hpf/ictf/querypageHospPrepayHeadVO.do`,
    //列表查询
    queryListByPks: `/nccloud/hpf/ictf/querypagebypkHospPrepayHeadVO.do`,
    //列表分页查询
    commit: `/nccloud/hpf/ictf/commitHospPrepayHeadVO.do`,
    //提交
    unCommit: `/nccloud/hpf/ictf/uncommitHospPrepayHeadVO.do`,
    //收回
    toCard: '/card',
    toList: '/list',
    down: `/nccloud/hpf/ictf/downHospPrepay.do`,
    //从中间库下载
    linkquery: '/nccloud/hpf/ictf/HospPrepayLinkQueryVoucher.do',
    //联查凭证
    makebill: '/nccloud/hpf/ictf/HospPrepayMakebill.do',
    //制单
    Print: '/nccloud/hpf/ictf/HospPrepayPrint.do',
    //打印
...
//主属性字段名
const PRIMARY_KEY = {
    head_id: 'pk_hosppreay',
    //表头主键字段名
    body_id: 'pk_hosppreay_b',
    //表体主键字段名
    bill_no: 'billno',
    //单据编号字段名
    id: 'id'
...
//# sourceMappingURL=index.64c795b5.js.map