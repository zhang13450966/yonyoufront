...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["hpf/ictf/m0z20604/constant/index"] = factory();
	else
		root["hpf/ictf/m0z20604/constant/index"] = factory();
})(self, () => {
...
* @description: 常量
*/ //应用编码
const APPCODE = 'M0Z20604';
//单据类型
const BILL_TYPE_CODE = 'HPF4';
/**
* @description: 多语
 ...
 * 列表
 */ const LIST = {
    page_title: 'M0Z20604-000011',
    //页面标题 /* 国际化处理： 投融资费用*/
    page_code: 'M0Z20604_LIST',
    //页面编码
...
//url
const REQUEST_URL = {
    save: `/nccloud/hpf/ictf/saveHospIncomeHeadVO.do`,
    //保存
    delete: `/nccloud/hpf/ictf/deleteHospIncomeHeadVO.do`,
    //删除
    queryCard: `/nccloud/hpf/ictf/querycardHospIncomeHeadVO.do`,
    //卡片查询
    queryList: `/nccloud/hpf/ictf/querypageHospIncomeHeadVO.do`,
    //列表查询
    queryListByPks: `/nccloud/hpf/ictf/querypagebypkHospIncomeHeadVO.do`,
    //列表分页查询
    commit: `/nccloud/hpf/ictf/commitHospIncomeHeadVO.do`,
    //提交
    unCommit: `/nccloud/hpf/ictf/uncommitHospIncomeHeadVO.do`,
    //收回
    down: `/nccloud/hpf/ictf/downHospIncomeHeadVO.do`,
    linkquery: '/nccloud/hpf/ictf/HospIncomeLinkQueryVoucher.do',
    makebill: '/nccloud/hpf/ictf/HospIncomeMakebill.do',
    toCard: '/card',
    toList: '/list',
    Print: '/nccloud/hpf/ictf/hospIncomePrint.do',
...
//主属性字段名
const PRIMARY_KEY = {
    head_id: 'pk_hospincome',
    //表头主键字段名
    body_id: 'pk_hospincome_b',
    //表体主键字段名
    bill_no: 'billno',
    //单据编号字段名
    id: 'id'
...
//# sourceMappingURL=index.1a8eac16.js.map