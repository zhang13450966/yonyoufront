...
export default class ButtonAction {
    ...
    printTable = () => {
        const {props} = this.comp;
        const {tripoff, editTable, meta} = props;

        let tableWrapper = document.getElementById('mainTable');

        this.print(tableWrapper, {
            title: tripoff.language['gx6008-000067'], // 录用办理
            maker: tripoff.language['gx6008-000068'], // 制作者
            date: tripoff.language['gx6008-000069'], // 制作日期
            tableInfo: {
